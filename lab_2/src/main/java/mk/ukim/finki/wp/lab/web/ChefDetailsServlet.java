...
public class ChefDetailsServlet extends HttpServlet {
    ...
    public ChefDetailsServlet(SpringTemplateEngine springTemplateEngine,
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String chefId = (String) req.getSession().getAttribute("selectedChefId");
        String dishId = (String) req.getSession().getAttribute("selectedDishId");

        if (chefId == null || dishId == null) {
